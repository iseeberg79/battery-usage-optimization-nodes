module.exports = function(RED) {
    function DetermineBatteryModeNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            let avgGridPriceWeekly = msg.avgGridPriceWeekly = ((typeof msg.avgGridPriceWeekly !== 'undefined') ? msg.avgGridPriceWeekly : 0.25) * 100;
            ...
            if (optimize) {
                ...
                if (pvControlMode === "insufficientPV" && (
                    (socControlMode === "lowSOC") || (socControlMode === "mediumSOC") && (msg.batterymode === "charge"))) {
                    ...
                    if (enableGridcharge && mayChargeBattery(price, minTotal, msg.avgGridPriceWeekly)) {
                        ...
                        lastGridchargePrice = (price / 100 * loss);
                    } else {
                        msg.targetMode = "hold";
                    }
                } else {
